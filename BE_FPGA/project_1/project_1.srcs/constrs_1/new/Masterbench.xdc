...
set_property -dict { PACKAGE_PIN V2  IOSTANDARD LVCMOS33 } [get_ports addr_B[0]]
set_property -dict { PACKAGE_PIN T3  IOSTANDARD LVCMOS33 } [get_ports addr_B[1]]
set_property -dict { PACKAGE_PIN T2  IOSTANDARD LVCMOS33 } [get_ports addr_B[2]]
set_property -dict { PACKAGE_PIN R3  IOSTANDARD LVCMOS33 } [get_ports addr_B[3]]
...
# Control signals
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports W]
...
set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports QB[0]]
set_property -dict { PACKAGE_PIN V3  IOSTANDARD LVCMOS33 } [get_ports QB[1]]
set_property -dict { PACKAGE_PIN W3  IOSTANDARD LVCMOS33 } [get_ports QB[2]]
set_property -dict { PACKAGE_PIN U3  IOSTANDARD LVCMOS33 } [get_ports QB[3]]
set_property -dict { PACKAGE_PIN P3  IOSTANDARD LVCMOS33 } [get_ports QB[4]]
set_property -dict { PACKAGE_PIN N3  IOSTANDARD LVCMOS33 } [get_ports QB[5]]
set_property -dict { PACKAGE_PIN P1  IOSTANDARD LVCMOS33 } [get_ports QB[6]]
set_property -dict { PACKAGE_PIN L1  IOSTANDARD LVCMOS33 } [get_ports QB[7]]